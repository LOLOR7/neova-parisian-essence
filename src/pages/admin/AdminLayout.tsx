...
import { LayoutDashboard, Inbox, Users, Send, Settings, LogOut, ShieldCheck, FileSignature } from "lucide-react";
...
export const AdminLayout = ({
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "hsl(34 22% 95%)" }}>
      {/* Sidebar */}
      <aside className="hidden md:flex md:w-[260px] flex-col bg-white border-r" style={{ borderColor: "hsl(30 12% 88%)" }}>
        <Link to="/admin" className="px-6 py-6 flex items-center gap-3 border-b" style={{ borderColor: "hsl(30 12% 90%)" }}>
          <div
